...
static MPASLLogger *sharedInstance;

@implementation MPASLLogger
{
    aslclient client;
}
...
{
    static dispatch_once_t MPASLLoggerOnceToken;
    dispatch_once(&MPASLLoggerOnceToken, ^{
...
- (void)logMessage:(MPLogMessage *)logMessage
{
    ...
    if (strcmp(logMessage->file, "MPASLLogCapture") == 0)
        return;
